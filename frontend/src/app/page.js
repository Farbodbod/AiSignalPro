...
const PriceTicker = () => {
    ...
    useEffect(() => {
        fetchPrices();
        const interval = setInterval(fetchPrices, 15000); // هر 15 ثانیه آپدیت
