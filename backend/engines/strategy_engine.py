# engines/strategy_engine.py (نسخه کاملاً نهایی و بی‌نقص 14.4)
...
class StrategyEngine:
    ...
    def _is_valid(self, strategy: Dict) -> bool:
        ...
        if self.atr and self.atr > 0:
            is_sl_safe = abs(self.entry_price - strategy.get("stop_loss", self.entry_price)) > self.atr * 0.3
    ...
    def _try_trend_strategy(self) -> Optional[Dict]:
        ...
        score += 3
        confirmations.append("Primary Trend Signal")
        ...
        if self.config.trend_macd_confirmation:
            ...
            score += 2
            confirmations.append("MACD Confirmed")
        ...
        score += 1
        confirmations.append("RSI Zone OK")
