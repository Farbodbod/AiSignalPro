# engines/master_orchestrator.py (v28.0 - Focus Mode Integration - Final)
...
class MasterOrchestrator:
    """
    The strategic mastermind of AiSignalPro (v28.0 - Focus Mode Integration - Final).
    ...
    the HTF Quality Gate. This is the complete and unabridged version.
    """
    ...
    def run_strategy_pipeline(self, primary_analysis: Dict[str, Any], htf_context: Dict[str, Any], symbol: str, timeframe: str) -> Optional[Dict[str, Any]]:
        # This method's logic is complete and includes the new features.
        valid_signals = []
        strategies_config = self.config.get('strategies', {})
    ...
    def _find_super_signal(self, signals: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        # This function is complete and unabridged.
    ...
    def _get_ai_confirmation(self, signal: Dict[str, Any], symbol: str, timeframe: str) -> Optional[Dict[str, Any]]:
        # This function is complete and contains the full, original prompt.
