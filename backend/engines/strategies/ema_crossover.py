#backend/engines/strategies/Ema_Crossover.py - (v7.0 - The Quantum Strategist)
...
class EmaCrossoverStrategy(BaseStrategy):
    """
    EmaCrossoverStrategy - (v7.0 - The Quantum Strategist)
    -------------------------------------------------------------------
    This version represents a quantum leap, evolving the strategy from a simple
    soldier into a forward-looking strategist. By following the Quantum Roadmap,
    this version now features:
    1.  **Adaptive Regime Filter:** Uses ADX percentile to operate only in strong,
        statistically significant trends.
    2.  **Adaptive Exhaustion Shield:** Employs dynamic RSI percentiles to avoid
        late entries at points of market exhaustion.
    3.  **Predictive Confirmation:** Actively seeks Hidden Divergence as a powerful
        confirmation for trend continuation, transforming its core philosophy.
    4.  **Recalibrated Elite Squad:** The scoring engine is re-weighted to prioritize
        these new, smarter confirmations.
    """
    strategy_name: str = "EmaCrossoverStrategy"

    default_config: ClassVar[Dict[str, Any]] = {
        # --- ✅ STAGE 1: Battlefield Selection (Upgraded) ---
        "market_regime_filter": {
            "enabled": True,
            "required_regime": "TRENDING",
            "adx_percentile_threshold": 70.0
        },
        # --- ✅ STAGE 2: Defensive Shields (Upgraded) ---
        "exhaustion_shield": {
            "enabled": True,
            "mode": "dynamic",
            "dynamic_rsi_lookback": 120,
            "dynamic_overbought_percentile": 85,
            "dynamic_oversold_percentile": 15
        },
        # --- ✅ STAGE 3: Predictive Sensor (Upgraded) ---
        "divergence_veto_enabled": False, # Replaced by offensive check
        
        # --- ✅ STAGE 4: Offensive Squad (Recalibrated) ---
        "min_confirmation_score": 12,
        "weights": {
            "master_trend": 4,
            "hidden_divergence": 4, # New powerful specialist
            "macd": 3,
            "adx_strength": 3,
            "stochastic_cross": 2,
            "volume": 2,
        ...
        "min_adx_percentile": 70.0, # Upgraded from fixed value
        "candlestick_confirmation_enabled": True,
        
        # --- STAGE 5: Logistics Officers (Unchanged) ---
        ...
        "htf_confirmations": {
            ...
            "adx": {"weight": 1, "min_percentile": 75.0}, # Upgraded from fixed value
            "supertrend": {"weight": 1}
        }
    }
    ...
    def check_signal(self) -> Optional[Dict[str, Any]]:
        ...
        required = ['ema_cross', 'atr', 'adx', 'rsi', 'divergence']
        ...
        # --- ✅ STAGE 1: BATTLEFIELD SELECTION (Upgraded to Adaptive) ---
        ...
        # --- ✅ STAGE 3: DEFENSIVE SHIELDS (Upgraded to Adaptive) ---
        ...
        # --- ✅ STAGE 4: OFFENSIVE SQUAD (Upgraded & Recalibrated) ---
        ...
        # ✅ New Specialist: Hidden Divergence Confirmation
        ...
        # --- STAGE 5: LOGISTICS (Risk Management) (Unchanged) ---
        ...
        self._log_final_decision(signal_direction, f"Quantum Strategist assembled. Score: {score}. Confirmed by: {', '.join(confirmations)}")
