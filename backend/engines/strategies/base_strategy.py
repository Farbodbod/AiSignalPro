...
class BaseStrategy(ABC):
    ...
    def _get_trend_confirmation(self, direction: str) -> bool:
        ...
        # ✅ FIX: Prevent UnboundLocalError by defining htf_rules first.
    ...
    def _calculate_smart_risk_management(self, entry_price: float, direction: str, stop_loss: float) -> Dict[str, Any]:
        ...
        # ✅ LOGIC FIX: More realistic fee calculation for R/R.
        total_risk_per_unit = risk_per_unit + (entry_price * slippage_pct) # Fees are added on entry and exit separately
        
        # ✅ FIX: Prevent UnboundLocalError by defining structure_data first.
