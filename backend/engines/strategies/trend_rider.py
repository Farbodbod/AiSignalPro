# backend/engines/strategies/trend_rider.py (v7.0 - The Context-Aware Engine)
...
class TrendRiderPro(BaseStrategy):
    """
    TrendRiderPro - (v7.0 - The Context-Aware Engine)
    -----------------------------------------------------------------------------------------
    This is the definitive, world-class version of the TrendRider. It is now a
    fully context-aware engine, incorporating the Market Regime Filter to ensure
    it only operates in trending markets. It is also fully hardened with NaN-guards,
    a true HTF dependency check, and a zero-risk shield.
    """
    ...
    default_config: ClassVar[Dict[str, Any]] = {
        ...
        "timeframe_overrides": {
            "5m": { "min_adx_strength": 22.0 },
            "1d": { "min_adx_strength": 28.0, "tactical_tp_rr_ratio": 2.5 }
        },
    ...
    def check_signal(self) -> Optional[Dict[str, Any]]:
        ...
        # Ensure risk_params is a dict before modification
