...
class ConfluenceSniper(BaseStrategy):
    """
    ConfluenceSniper - (v2.1 - Corrected HTF Logic)
    -------------------------------------------------------------------
    ...
    def _get_oscillator_confirmation(self, direction: str, rsi_data: Dict[str, Any], stoch_data: Dict[str, Any]) -> bool:
        ...
        if direction == "BUY": return rsi_val < rsi_os and stoch_pos == 'Oversold'
        elif direction == "SELL": return rsi_val > rsi_ob and stoch_pos == 'Overbought'
        return False
    ...
    def check_signal(self) -> Optional[Dict[str, Any]]:
        ...
        if not all([fib_data, structure_data, rsi_data, stoch_data, atr_data]): return None
        ...
        if cfg['oscillator_confirmation_enabled']:
            if not self._get_oscillator_confirmation(direction, rsi_data, stoch_data): return None
